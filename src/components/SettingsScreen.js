  ...
  if(!fontsLoaded){
    ...
    return(
      ...
      <Image
        ...
        <Box title='Edit Profile' width='90%' height='22.5%' img='https://i.ibb.co/W3yCVgd/bg5.png' textColor={theme.colors.offwhite} iconName='newspaper' direction='row' centerTextPercent='85%' route='EditProfile'></Box>
