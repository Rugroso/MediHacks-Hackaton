...
export default function HomeScreen(){
    ...
    <Image
      ...
      <Box title='Meditation' width='45%' height='30%' img='https://i.ibb.co/0qbnSyD/bg.png'></Box>
      <Box title='CalmPlay' width='45%' height='30%' img='https://i.ibb.co/5Yv3Lj2/bg2.png'></Box>
